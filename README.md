...
2. Get your copy of bookcorpusopen_chunked dataset via __copying__ to your/own/path, either from:
...
4. Move the PPCM models to our repo:
    1. `cd ..`
    2. `mkdir ppcm_models/dialoGPT`
    3. `mv PPCM/models/dialoGPT/* ppcm_models/dialoGPT/`
4. In the `run_adapter_train.sh` change the dataset_path to `your/own/path`
